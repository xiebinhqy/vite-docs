...
::: tip 说明
这里的 `aside-outline-before` 和 `doc-before` 是 插槽
...
当 **Frontmatter** 配置 `layout: doc` (默认)时插槽及位置
...
![xx](https://img.deattor.us.kg/file/1729780314041_layout-doc.png)


### home

当 Frontmatter 配置 `layout: home` (默认)时插槽及位置
...
![alt text](https://img.deattor.us.kg/file/1729781583062_layout-home.png)


### page

当 Frontmatter 配置 `layout: page` (默认)时插槽及位置

 - page-top
 - page-bottom

 
![alt text](https://img.deattor.us.kg/file/1729781660112_layout-page.png)
...
![alt text](https://img.deattor.us.kg/file/1729781772596_layout-nav.png)
...
本方法参考 掘金 [掘金 @Younglina](https://juejin.cn/post/7134586612406714375) 的文章
...
![alt text](https://img.deattor.us.kg/file/1729782108219_layout-demo-01.png)
...
![alt text](https://img.deattor.us.kg/file/1729782417849_layout-vite.png)

在 `utils` 目录新建一个 `sponsors.ts` 文件
...
这里我建议使用 **插槽**：`doc-footer-before`，不需要添加到文章中就能使用
...
::: details 疑问：我的其他插槽怎么使用
以 返回顶部 backtotop.vue 为例，将它的代码单独添加到 `MyLayout.vue` 中
:::
