...
export const NAV_DATA: NavData[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://img.deattor.us.kg/file/1730875253476_logo-Bni1bEBk.png',
        title: 'AI绘画(cogniwerk)',
        link: 'https://cogniwerk.ai/run-model/illustration-style'
      },
      {
        icon: 'https://img.deattor.us.kg/file/1730880042683_yaru.png',
        title: '人脸识别搜索引擎',
        link: 'https://ya.ru/'
      },
      {
        icon: 'https://img.deattor.us.kg/file/1730880153965_ffacecheck.png',
        title: '人脸识别反向搜索引擎',
        link: 'https://facecheck.id/zh'
      },
      {
        icon: 'https://img.deattor.us.kg/file/1730883798447_QQ20241106-170255.png',
        title: 'AI绘画',
        link: 'https://tengr.ai/en/auth/login'
      },
    ]
  },
  {
    ...
    items: [
      {
        icon: 'https://img.deattor.us.kg/file/1730863165120_logo_redteago_blue.6b3b5cd.png',
        title: 'RedteaGO',
        desc: 'Esim 便宜全球ESIM卡',
        link: 'https://esim.redteago.com/zh-CN'
      },
      {
        icon: '/logo.png',
        title: '前端思维导图',
  ...
  },
  {
    ...
    items: [
      {
        icon: 'https://img.deattor.us.kg/file/1730863382662_QQ20241106-112222.png',
        title: 'Proton VPN',
        desc: '链接全球备用节点',
        link: 'https://account.protonvpn.com/zh-tw/login'
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        icon: 'https://img.deattor.us.kg/file/1730876380338_vistacreate.png',
        title: 'create.vista',
        desc: 'LOGO在线生成,免费',
        link: 'https://create.vista.com/home/'
      },
      {
