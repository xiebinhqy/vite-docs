...
export const NAV_DATA: NavData[] = [
  {
    ...
    items: [
      ...
      {
        icon: 'https://img.deattor.us.kg/file/1730883214045_QQ20241106-165313.png',
        title: 'IP检测',
        badge: {
          text: '检测本地环境IP',
          type: 'danger',
        },
        desc: 'IP address | IP检测',
        link: 'https://www.myip.com/'
      },
      {
        icon: 'https://img.deattor.us.kg/file/1730883392091_QQ20241106-165615.png',
        title: 'IP检测',
        badge: {
          text: '检测本地环境IP纯净度',
          type: 'warning',
        },
        desc: 'Oracle Corporation | 网站欺诈风险检测',
  ...
  },
  {
    ...
    items: [
      {
        icon: 'https://img.deattor.us.kg/file/1730879026536_butterfly-icon.png',
        title: 'HEXO-Butterfly',
        desc: 'HEXO-主题Butterfly文檔配置',
        link: 'https://butterfly.js.org/'
      },
      {
        icon: 'https://img.deattor.us.kg/file/1730879266698_cover.png',
        title: 'HEXO-安知鱼主题',
        desc: '一个基于HEXO的博客主题',
        link: 'https://docs.anheyu.com/'
      },
      {
        icon: 'https://img.deattor.us.kg/file/1730879664144_pexels.png',
        title: '网站图片视频素材',
        desc: '免费分型素材图片和视频',
        link: 'https://www.pexels.com/zh-cn/'
      },
      {
        icon: 'https://img.deattor.us.kg/file/1730879739115_wallroom.png',
        title: '网站图片视频素材',
        desc: '免费分型素材图片和视频',
        link: 'https://wallroom.io/'
      },
      {
        icon: 'https://img.deattor.us.kg/file/1730886857394_pm2.png',
        title: 'PM2',
        desc: 'Node.js进程管理器',
        link: 'https://id.keymetrics.io/api/oauth/login'
      },
  ...
  },
  {
    ...
    items: [
      {
        icon: 'https://img.deattor.us.kg/file/1730884639366_logo-150.png',
        title: 'PicGo-上传工具',
        desc: '图片上传和管理新体验',
        link: 'https://picgo.github.io/PicGo-Doc/en/guide/#picgo-is-here'
      },
      {
        icon: 'https://img.deattor.us.kg/file/1730879266698_cover.png',
        title: 'HEXO-安知鱼主题',
  ...
  },
  {
    ...
    items: [
      {
        icon: 'https://img.deattor.us.kg/file/1730886495039_akamai.png',
        title: 'Akamai Cloud Manager',
        desc: '🏳️‍🌈便宜的云服务商',
        link: 'https://cloud.linode.com/linodes'
      },
      {
        icon: 'https://img.deattor.us.kg/file/1730886973512_serv00.png',
        title: 'Serv00免费服务器',
        desc: '一个荷兰的免费服务器',
        link: 'https://www.serv00.com/offer/create_new_account'
      },
      {
        icon: 'https://img.deattor.us.kg/file/1730879664144_pexels.png',
        title: '网站图片视频素材',
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://img.deattor.us.kg/file/1730875508831_logo.png',
        title: 'VitePress',
        desc: 'vitepress快速上手中文教程',
        link: 'https://vitepress.yiov.top/'
      },
      {
        icon: 'https://img.deattor.us.kg/file/1730875973724_logo-1.png',
        title: 'Yuzai Docs',
        desc: 'yuzai-vitepress教程',
